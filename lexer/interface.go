...
var (
	NOT_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NOT_TEXT,
		BothBoundaries,
	)
	NULLIFY_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NULLIFY_TEXT,
		BothBoundaries,
	)
	TRUIFY_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		TRUIFY_TEXT,
		BothBoundaries,
	)
...
var (
	AND_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		AND_TEXT,
		BothBoundaries,
	)
	AND_SYMB_WB  EscapedAndWBString = NewEscapedAndWBString(AND_SYMB, NoBoundary)
	NAND_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NAND_TEXT,
		BothBoundaries,
	)
	NAND_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(NAND_SYMB, NoBoundary)
	OR_TEXT_WB   EscapedAndWBString = NewEscapedAndWBString(
		OR_TEXT,
		BothBoundaries,
	)
	OR_SYMB_WB  EscapedAndWBString = NewEscapedAndWBString(OR_SYMB, NoBoundary)
	NOR_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NOR_TEXT,
		BothBoundaries,
	)
	NOR_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(NOR_SYMB, NoBoundary)

	XNOR_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		XNOR_TEXT,
		BothBoundaries,
	)
	IFF_TEXT_WB  EscapedAndWBString = NewEscapedAndWBString(IFF_TEXT, NoBoundary)
	XNOR_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		XNOR_SYMB,
		BothBoundaries,
	)

	XOR_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		XOR_TEXT,
		BothBoundaries,
	)
	XOR_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(XOR_SYMB, NoBoundary)

	IMPLIES_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		IMPLIES_TEXT,
		BothBoundaries,
	)
	IMPLIES_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		IMPLIES_SYMB,
		NoBoundary,
	)
	IMPLIED_BY_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		IMPLIED_BY_TEXT,
		BothBoundaries,
	)
	IMPLIED_BY_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		IMPLIED_BY_SYMB,
		NoBoundary,
	)

	INHIBITS_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		INHIBITS_TEXT,
		BothBoundaries,
	)
	INHIBITS_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		INHIBITS_SYMB,
		NoBoundary,
	)
	...
	INHIBITED_BY_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		INHIBITED_BY_SYMB,
		NoBoundary,
	)

	LEFT_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		LEFT_TEXT,
		BothBoundaries,
	)
	LEFT_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		LEFT_SYMB,
		NoBoundary,
	)
	RIGHT_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		RIGHT_TEXT,
		BothBoundaries,
	)
	RIGHT_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		RIGHT_SYMB,
		NoBoundary,
	)

	NOT_LEFT_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NOT_LEFT_TEXT,
		BothBoundaries,
	)
	NOT_LEFT_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		NOT_LEFT_SYMB,
		NoBoundary,
	)
	NOT_RIGHT_TEXT_WB EscapedAndWBString = NewEscapedAndWBString(
		NOT_RIGHT_TEXT,
		BothBoundaries,
	)
	NOT_RIGHT_SYMB_WB EscapedAndWBString = NewEscapedAndWBString(
		NOT_RIGHT_SYMB,
		NoBoundary,
	)
)
...
func BuildSimpleRules(tds []TokenDef) []participleLexer.SimpleRule {
	var rules []participleLexer.SimpleRule
	for _, td := range tds {
		switch {
		case td.Regex != "":
			rules = append(rules, participleLexer.SimpleRule{
				Name:    td.Name,
				Pattern: td.Regex,
			})
...
var BooleanLexer = participleLexer.MustSimple(simpleRules)
